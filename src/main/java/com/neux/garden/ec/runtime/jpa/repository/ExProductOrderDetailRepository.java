...
/*
* <p> Source File Name: ExProductOrderDetailRepository.java </p>
...
public interface ExProductOrderDetailRepository extends JpaRepository<ExProductOrderDetail, String> {
